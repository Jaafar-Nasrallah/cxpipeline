...
public class CxPipeline {
    ...
    public static void main(String[] args) {
        ...
        String requestFilePath = currentWorkingDir + "\\requests.json";
        String outputFilePath = currentWorkingDir + "\\output.txt";
        ...
        //put the countryNames in an output.txt file and write to disk
        PCollection<String> countryNameRequests = countryNames.apply(MapElements.via(new FormatAsTextFn()));
        countryNameRequests.apply(TextIO.write().withoutSharding().to(outputFilePath));
